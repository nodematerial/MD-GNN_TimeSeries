...
def main():
    ...
    gnn_layer_hidden_dim = CFG['gnn_layer_hidden_dim']
    last_layer_hidden_dim = CFG['last_layer_hidden_dim']
    model = GCNModel(in_channels, gnn_layer_hidden_dim, last_layer_hidden_dim).to(device)
